...
class GoogleGetToken extends Command
{
     ...
     * @var string
     */
    protected $description = 'Get token google';
...
//        $client->setRedirectUri('http://dethi.com:8888/');
        $client->setRedirectUri('https://developers.google.com/oauthplayground');
        $client->setApplicationName('dethi'); // đặt tên cho ứng dụng (không quan trọng lắm)
        ...
        $client->setScopes([
            ...
            \Google_Service_PhotosLibrary::PHOTOSLIBRARY_APPENDONLY,
            \Google_Service_PhotosLibrary::PHOTOSLIBRARY_READONLY_APPCREATEDDATA,
